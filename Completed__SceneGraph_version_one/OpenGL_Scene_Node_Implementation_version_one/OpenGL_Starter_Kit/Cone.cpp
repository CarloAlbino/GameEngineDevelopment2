...
Cone::Cone(glm::mat4 transformation, float scale, float radius, float height) : SceneNode(transformation, scale)
{
	m_radius = radius;
	m_height = height;
}

Cone::Cone(glm::mat4 transformation, glm::vec3 scale, float radius, float height)
